 ...
 * Tue Mar 10 2020 10:29:40 GMT-0300 (Horário Padrão de Brasília)
...
operateAnimation('PLAY', 'M.M.Ouro', null, null, 'AUTO', 1,
        function() {}, undefined, false);

    assignMat('Ingles', 'M.Ingl.en');
changeVis('Blender-Logo', false);
changeVis('Suzane', false);
changeVis('Eu', false);

registerOnClick('M.R.Blender', function() {
  changeVis('Blender-Logo', true);
  changeVis('Suzane', false);
  changeVis('Eu', false);
}, function() {});

registerOnClick('Reset', function() {
  assignMat('Medalha', 'Material');
  assignMat('Blender-Logo', 'Material');
  assignMat('Suzane', 'Material');
  assignMat('Eu', 'Material');
  assignMat('Mouse', 'Mouse-en');
  changeVis('Blender-Logo', false);
  changeVis('Suzane', false);
  changeVis('Eu', false);
}, function() {});

registerOnClick('M.M.Ouro', function() {
  assignMat('Medalha', 'ouro');
}, function() {});
registerOnClick('M.M.Ouro', function() {
  assignMat('Eu', 'ouro');
}, function() {});
registerOnClick('M.M.Ouro', function() {
  assignMat('Blender-Logo', 'ouro');
}, function() {});
registerOnClick('M.M.Ouro', function() {
  assignMat('Suzane', 'ouro');
}, function() {});

registerOnClick('M.R.Suzanne', function() {
  changeVis('Suzane', true);
  changeVis('Blender-Logo', false);
  changeVis('Eu', false);
}, function() {});

registerOnClick('M.R.Eu', function() {
  changeVis('Eu', true);
  changeVis('Blender-Logo', false);
  changeVis('Suzane', false);
}, function() {});

registerOnClick('M.M.Prata', function() {
  assignMat('Medalha', 'prata');
}, function() {});
registerOnClick('M.M.Prata', function() {
  assignMat('Eu', 'prata');
}, function() {});
registerOnClick('M.M.Prata', function() {
  assignMat('Blender-Logo', 'prata');
}, function() {});
registerOnClick('M.M.Prata', function() {
  assignMat('Suzane', 'prata');
}, function() {});

registerOnClick('Português', function() {
  assignMat('Português', 'M.Port.pt');
  assignMat('Ingles', 'M.Ingl.pt');
  assignMat('M.R.Medalha', 'M.Malha.pt');
  assignMat('M.R.Material', 'M.Material.pt');
  assignMat('Mouse', 'Mouse-pt');
}, function() {});

registerOnClick('M.M.Bronze', function() {
  assignMat('Medalha', 'bronze');
}, function() {});
registerOnClick('M.M.Bronze', function() {
  assignMat('Eu', 'bronze');
}, function() {});
registerOnClick('M.M.Bronze', function() {
  assignMat('Blender-Logo', 'bronze');
}, function() {});
registerOnClick('M.M.Bronze', function() {
  assignMat('Suzane', 'bronze');
}, function() {});

registerOnClick('Ingles', function() {
  assignMat('Português', 'M.Port.en');
  assignMat('Ingles', 'M.Ingl.en');
  assignMat('M.R.Medalha', 'M.Malha.en');
  assignMat('M.R.Material', 'M.Material.en');
  assignMat('Mouse', 'Mouse-en');
}, function() {});
